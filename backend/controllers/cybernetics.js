const Cybernetic = require("../models/cybernetic");
...
exports.updateCybernetic = (req, res, next) => {
  ...
  Cybernetic.updateOne({_id: req.params.id}, cybernetic)
    .then(result => {
      console.log (result);
...
exports.getOneCybernetic = (req, res, next) => {
  Cybernetic.findById(req.params.id)
    .then(cybernetic => {
      if (cybernetic) {
...
exports.deleteCybernetic = (req, res, next) => {
  Cybernetic.deleteOne({ _id: req.params.id})
    .then(result => {
      console.log(result);
